...
- **Codex work in the browser.** Open a local project in Work Sessions, stream native Codex activity and approvals, and keep working across refreshes or tabs. Requires an up-to-date Codex CLI.
