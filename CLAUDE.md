...
- A separate trusted `Dependency Cache` workflow runs after pushes to `main` only to publish reusable uv dependency artifacts. It never reruns validation and is not a required status check.
