...
SECTIONS: tuple[ConfigSectionSpec, ...] = (
    ...
    ConfigSectionSpec(
        "fusion",
        "Model Fusion",
        "Multi-model synthesis and ensemble expert panels.",
    ),
    ConfigSectionSpec(
        "routing_adv",
        "Advanced Routing",
        "Race Mode, Model Clustering, and Semantic Intent Probe.",
    ),
    ConfigSectionSpec(
        "caching",
        "Caching",
        "Performance optimizations for repetitive requests.",
    ),
    ConfigSectionSpec(
        "diagnostics",
        "Diagnostics",
...
FIELDS: tuple[ConfigFieldSpec, ...] = (
    ...
    ConfigFieldSpec(
        "ENABLE_SYNTHETIC_THINKING",
        "Synthetic Thinking",
        "thinking",
        "boolean",
        settings_attr="enable_synthetic_thinking",
        default="true",
        description="Inject <think> tags instruction for models that don't support native reasoning.",
    ),
    ConfigFieldSpec(
        "ENABLE_SYNTHETIC_TOOLS",
        "Synthetic Tools",
        "web_tools",
        "boolean",
        settings_attr="enable_synthetic_tools",
        default="true",
        description="Allow legacy models to use tools by parsing their text output for tags like ● <function=...>",
    ),
    ConfigFieldSpec(
        ...
        "caching",
        "number",
        settings_attr="context_compression_threshold",
        default="0",
        description="Auto-compress history if token count exceeds this (0 to disable).",
    ),
    ConfigFieldSpec(
        "ROUTING_PROBE_MODEL",
        "Probe Classifier Model",
        "routing_adv",
        settings_attr="routing_probe_model",
        description="Fast model used for intent classification (defaults to Haiku tier).",
    ),
    ConfigFieldSpec(
        "VISION_EXPERT_MODEL",
        "Vision Bridge Expert",
        "fusion",
        settings_attr="vision_expert_model",
        description="Model with native vision support used to describe images for text-only models.",
    ),
    ConfigFieldSpec(
    ...
    ConfigFieldSpec(
        ...
        "caching",
        "boolean",
        settings_attr="enable_response_caching",
        default="false",
        description="Cache deterministic model responses locally to reduce latency.",
    ),
    ConfigFieldSpec(
        "FUSION_PANELS",
        "Fusion Panels",
        "fusion",
        "textarea",
        settings_attr="fusion_panels",
        description="Semicolon-separated named panels. Format: coding=judge:m1,m2;general=judge:m3,m4",
    ),
    ConfigFieldSpec(
