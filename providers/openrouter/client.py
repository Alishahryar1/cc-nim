...
through a unified OpenAI-compatible API. They offer a free tier.
"""
        ...
        try:
            ...
            async for chunk in stream:
                ...
                if choice.finish_reason:
                    ...
                    logger.debug(f"OPENROUTER finish_reason: {finish_reason}")

                # Handle reasoning content (some OpenRouter models support this)
